...
DATABASE_NAME = 'alf_internal'             # Or path to database file if using sqlite3.
DATABASE_USER = 'alf_user'             # Not used with sqlite3.
...
MIDDLEWARE_CLASSES = (
    ...
    'alfresco.middleware.AlfrescoMiddleware',
)

AUTHENTICATION_BACKENDS = ('alfresco.backends.AlfrescoBackend',)
...
# You can create a local_settings file in your project.
# This will make sure you don't kill your DB information everytime.
try:
